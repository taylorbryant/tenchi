...
uv run tenchi openapi --routes app.server.routes:api_routes \
  --title Todos --version 0.1.0 --write openapi.json
uv run tenchi openapi --routes app.server.routes:api_routes \
  --title Todos --version 0.1.0 --check openapi.json
```
...
```shell
uv run tenchi openapi --routes app.server.routes:api_routes \
  --title Todos --version 0.1.0 --diff openapi-baseline.json
```
...
```shell
uv run tenchi openapi --routes app.server.routes:api_routes \
  --title Todos --version 0.1.0 \
  --diff-ref "$BASE_SHA" --snapshot openapi.json
uv run tenchi openapi --routes app.server.routes:api_routes \
  --title Todos --version 0.1.0 --check openapi.json
```
