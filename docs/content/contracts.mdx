...
Contracts are private by default. `public=True` is metadata for authentication
hooks and OpenAPI security; it does not authenticate or authorize a request by
itself.
