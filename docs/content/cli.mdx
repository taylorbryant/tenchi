...
SQLite persistence with request-scoped transactions, a memory test adapter, strict checks,
integration tests, Swagger UI, an OpenAPI snapshot, and GitHub Actions CI.
