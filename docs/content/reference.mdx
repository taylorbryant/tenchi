...
| `tenchi.compatibility` | `CompatibilityChange`, `CompatibilityReport`, `analyze_openapi_compatibility()`, `analyze_tool_compatibility()`, `analyze_evaluation_compatibility()`, `render_compatibility_report()`, `render_tool_compatibility_report()`, `render_evaluation_compatibility_report()` |
...
application-tool, and evaluation-policy snapshots. Modules such as `tenchi.cli`,
