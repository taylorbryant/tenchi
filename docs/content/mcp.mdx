...
one first-adoption comparison. The returned policy result then records an
`evaluation manifest baseline` metadata change; do not authorize this for a
renamed or mistyped path.
